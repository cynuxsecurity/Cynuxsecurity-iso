...
complete -c cmake -l files-from -d 'Read file names from the given file, one per line.  Blank lines are ignored'
complete -c cmake -l format -d 'Specify the format of the archive to be created'
complete -c cmake -l mtime -d 'Specify modification time recorded in tarball entries'
