# node
# Autogenerated from man page /usr/lib/jvm/default/man/man1/node.1.gz
...
complete -c node -l max-http-header-size -d 'Specify the maximum size of HTTP headers in bytes.  Defaults to 16KB'
