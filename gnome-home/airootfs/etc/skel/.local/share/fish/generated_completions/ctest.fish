# ctest
# Autogenerated from man page /usr/lib/jvm/default/man/man1/ctest.1.gz
...
complete -c ctest -s L -l label-regex -d 'Run tests with labels matching regular expression'
...
complete -c ctest -l test-output-size-passed -d 'Limit the output for passed tests to <size> bytes'
complete -c ctest -l test-output-size-failed -d 'Limit the output for failed tests to <size> bytes'
