# valac
# Autogenerated from man page /usr/lib/jvm/default/man/man1/valac.1.gz
...
complete -c valac -l profile -d 'Use the given profile instead of the default, options are \'gobject\' or \'posix\''
