# fcat
# Autogenerated from man page /usr/lib/jvm/default/man/man1/fcat.1.gz
...
complete -c fcat -s R -d 'Supress errors if a deleted file is being recovered'
...
complete -c fcat -s V -d 'Display version image [images] The disk or partition image to read, whose for…'
